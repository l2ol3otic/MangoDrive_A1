...
public class ContactControl extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.linearcontact);
        fa = this;
        ...
        TextView t2 = (TextView)mCustomView.findViewById(R.id.imageButton2);
        t2.setText("Next");
        mTitleTextView.setText("AutoAnswer");
        ...
        n1.setText(sharedpreferences.getString("callnumber1","No Contact"));
        n2.setText(sharedpreferences.getString("callnumber2","No Contact"));
        n3.setText(sharedpreferences.getString("callnumber3","No Contact"));
        n4.setText(sharedpreferences.getString("callnumber4","No Contact"));
        n5.setText(sharedpreferences.getString("callnumber5","No Contact"));
        n6.setText(sharedpreferences.getString("callnumber6","No Contact"));

        Log.d("Check Call 1 ",sharedpreferences.getString("callnumber1","A"));
        final ImageView img1 = (ImageView) findViewById(R.id.img1);
        p1 = sharedpreferences.getString("infopic1","");
        Log.d("Check p1",p1);
        ...
        p2 = sharedpreferences.getString("infopic2","");
        Log.d("Check p2",p2);
        ...
        p3 = sharedpreferences.getString("infopic3","");
        Log.d("Check p3",p3);
        ...
        p4 = sharedpreferences.getString("infopic4","");
        Log.d("Check p4",p4);
        ...
        p5 = sharedpreferences.getString("infopic5","");
        Log.d("Check p5",p5);
        ...
        p6 = sharedpreferences.getString("infopic6","");
        Log.d("Check p6",p6);
        ...
        im2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ContactControl.this, ContactControlReject.class);
                startActivity(intent);

                sharedpreferences = getSharedPreferences("callnumber", Context.MODE_PRIVATE);

                Log.d("Check Call 1 ",sharedpreferences.getString("callnumber1","A"));
                Log.d("Check Call 2 ",sharedpreferences.getString("callnumber2","B"));
                Log.d("Check Call 3 ",sharedpreferences.getString("callnumber3","C"));
                Log.d("Check Call 4 ",sharedpreferences.getString("callnumber4","D"));
                Log.d("Check Call 5 ",sharedpreferences.getString("callnumber5","E"));
                Log.d("Check Call 6 ",sharedpreferences.getString("callnumber6","F"));
                        ...
                        if (cursorNum.moveToNext()) {
                            ...
                            if(a==1) {
                               ...
                               if(String.valueOf(Pic) == "null"){
                                    Picasso.with(getApplicationContext()).load(R.drawable.nopicture).transform(new RoundPic()).into(img1);
                                    editors = sharedpreferences.edit();
                                    editors.putString("callnumber1",stringNumber);
                                    editors.putString("infopic1","null");
                                    editors.commit();
                                }
                                else {
                                    editors = sharedpreferences.edit();
                                    editors.putString("callnumber1",stringNumber);
                                    editors.putString("infopic1",String.valueOf(my_contact_Uri));
                                    editors.commit();
                               ...
                               // Log.d("NamePic", String.valueOf(fname));
                                ...
                                n1.setText(sharedpreferences.getString("callnumber1","A"));
                                ...
                                if(String.valueOf(Pic) == "null"){
                                    Picasso.with(getApplicationContext()).load(R.drawable.nopicture).transform(new RoundPic()).into(img2);
                                    editors = sharedpreferences.edit();
                                    editors.putString("callnumber2",stringNumber);
                                    editors.putString("infopic2","null");
                                    editors.commit();
                                }
                                else {
                                    editors = sharedpreferences.edit();
                                    editors.putString("callnumber2", stringNumber);
                                    editors.putString("infopic2", String.valueOf(my_contact_Uri));
                                    editors.commit();
                                    InputStream photo_stream = ContactsContract.Contacts.openContactPhotoInputStream(getContentResolver(), my_contact_Uri);
                                    BufferedInputStream buf = new BufferedInputStream(photo_stream);
                                    Bitmap my_btmp = BitmapFactory.decodeStream(buf);
                                ...
                                if(String.valueOf(Pic) == "null"){
                                    Picasso.with(getApplicationContext()).load(R.drawable.nopicture).transform(new RoundPic()).into(img3);
                                    editors = sharedpreferences.edit();
                                    editors.putString("callnumber3",stringNumber);
                                    editors.putString("infopic3","null");
                                    editors.commit();
                                }
                                else {
                                    editors = sharedpreferences.edit();
                                    editors.putString("callnumber3", stringNumber);
                                    editors.putString("infopic3", String.valueOf(my_contact_Uri));
                                    editors.commit();
                                    InputStream photo_stream = ContactsContract.Contacts.openContactPhotoInputStream(getContentResolver(), my_contact_Uri);
                                    BufferedInputStream buf = new BufferedInputStream(photo_stream);
                                    Bitmap my_btmp = BitmapFactory.decodeStream(buf);
                                ...
                                if(String.valueOf(Pic) == "null"){
                                    Picasso.with(getApplicationContext()).load(R.drawable.nopicture).transform(new RoundPic()).into(img4);
                                    editors = sharedpreferences.edit();
                                    editors.putString("callnumber4",stringNumber);
                                    editors.putString("infopic4","null");
                                    editors.commit();
                                }
                                else {
                                    editors = sharedpreferences.edit();
                                    editors.putString("callnumber4", stringNumber);
                                    editors.putString("infopic4", String.valueOf(my_contact_Uri));
                                    editors.commit();
                                    InputStream photo_stream = ContactsContract.Contacts.openContactPhotoInputStream(getContentResolver(), my_contact_Uri);
                                    BufferedInputStream buf = new BufferedInputStream(photo_stream);
                                    Bitmap my_btmp = BitmapFactory.decodeStream(buf);
                                ...
                                if(String.valueOf(Pic) == "null"){
                                    Picasso.with(getApplicationContext()).load(R.drawable.nopicture).transform(new RoundPic()).into(img5);
                                    editors = sharedpreferences.edit();
                                    editors.putString("callnumber5",stringNumber);
                                    editors.putString("infopic5","null");
                                    editors.commit();
                                }
                                else {
                                    editors = sharedpreferences.edit();
                                    editors.putString("callnumber5", stringNumber);
                                    editors.putString("infopic5", String.valueOf(my_contact_Uri));
                                    editors.commit();
                                    InputStream photo_stream = ContactsContract.Contacts.openContactPhotoInputStream(getContentResolver(), my_contact_Uri);
                                    BufferedInputStream buf = new BufferedInputStream(photo_stream);
                                    Bitmap my_btmp = BitmapFactory.decodeStream(buf);
                                ...
                                if(String.valueOf(Pic) == "null"){
                                    Picasso.with(getApplicationContext()).load(R.drawable.nopicture).transform(new RoundPic()).into(img6);
                                    editors = sharedpreferences.edit();
                                    editors.putString("callnumber6",stringNumber);
                                    editors.putString("infopic6","null");
                                    editors.commit();
                                }
                                else {
                                    editors = sharedpreferences.edit();
                                    editors.putString("callnumber6", stringNumber);
                                    editors.putString("infopic6", String.valueOf(my_contact_Uri));
                                    editors.commit();
                                    InputStream photo_stream = ContactsContract.Contacts.openContactPhotoInputStream(getContentResolver(), my_contact_Uri);
                                    BufferedInputStream buf = new BufferedInputStream(photo_stream);
                                    Bitmap my_btmp = BitmapFactory.decodeStream(buf);
