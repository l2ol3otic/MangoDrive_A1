...
public class GMapV2Direction {
    ...
    public  ArrayList getDistanceTBT(Document doc){
        ArrayList<String> DTBT = new ArrayList();
        NodeList nl1 = doc.getElementsByTagName("step");
            for(int i =0;i<nl1.getLength();i++){
                ...
                String distance = String.valueOf(node3.getTextContent());
                DTBT.add(distance);
            }
        return DTBT;
    }
    public ArrayList getTBT (Document doc){
        ArrayList<String> TBTA = new ArrayList();
        NodeList tbt = doc.getElementsByTagName("html_instructions");
        if(tbt.getLength()>0){
            for (int i = 0; i < tbt.getLength(); i++) {
                Node node1 = tbt.item(i);
                String t3 = node1.getTextContent();
                Log.i("Node1", node1.getTextContent());
                TBTA.add(t3);
            }
        }
        return  TBTA;
